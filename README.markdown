...
This directory contains source files for the Bulgarian language
...
-   <http://giellatekno.uit.no/buldoc/index.html>
-   <https://giellalt.uit.no/tools/docu-bul-manual.html>
...
The Bulgarian language sources can be acquired using [giella SVN
