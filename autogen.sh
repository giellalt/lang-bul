...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_bul to login script."
...
# the current dir:
if   test x${GTLANG_bul} = x ; then
	echo "WARNING: The variable \${GTLANG_bul} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_bul} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_bul} has the value:"
	echo "  ${GTLANG_bul}"
